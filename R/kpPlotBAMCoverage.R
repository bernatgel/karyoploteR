...
#' 
#' @usage kpPlotBAMCoverage(karyoplot, data=NULL, max.valid.region.size=1e6, ymin=NULL, ymax=NULL, data.panel=1, r0=NULL, r1=NULL, col=NULL, border=NA, clipping=TRUE,...)
#' 
...
kpPlotBAMCoverage <- function(karyoplot, data=NULL, max.valid.region.size=1e6, ymin=NULL, ymax=NULL, data.panel=1, r0=NULL, r1=NULL, col=NULL, border=NA, clipping=TRUE,...) {
...
parameter.")
  ...
  for(i in seq_len(length(karyoplot$plot.region))) {
    ...
    kpArea(karyoplot, chr=seqnames(r), x=seq.int(start(r), end(r)), y=bam.cov[i], ymin=ymin, ymax=ymax, data.panel=data.panel, r0=r0, r1=r1, border=border, col=col, clipping=clipping, ...)
  }

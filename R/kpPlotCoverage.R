...
#'
#' @usage kpPlotCoverage(karyoplot, data, data.panel=1, r0=NULL, r1=NULL, autotrack=NULL, col="#0e87eb", ymax=NULL, clipping=TRUE, ...)
#' 
...
kpPlotCoverage <- function(karyoplot, data, data.panel=1, r0=NULL, r1=NULL, autotrack=NULL, col="#0e87eb", ymax=NULL, clipping=TRUE, ...) {
  #Check parameters
  #karyoplot

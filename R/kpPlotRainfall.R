...
#' of close mutations.
#' 
#' @usage kpPlotRainfall(karyoplot, data=NULL, col=NULL, ymin=NULL, ymax=7, data.panel=1, r0=NULL, r1=NULL, autotrack=NULL, clipping=TRUE, ...)
#' 
...
kpPlotRainfall <- function(karyoplot, data=NULL, col=NULL, ymin=NULL, ymax=7, data.panel=1, r0=NULL, r1=NULL, autotrack=NULL, clipping=TRUE, ...) {

...
kp <- plotKaryotype(chromosomes = c("chr1", "chr2"), plot.type = 1, plot.params = plot.params, add.cytobands.names=TRUE, cytobands.names.cex=0.25, add.base.numbers=TRUE) %>%
  kpDataBackground(data.panel = 1)
@
